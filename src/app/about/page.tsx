    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8 max-w-3xl mx-auto">
      <div className="w-full space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold text-white tracking-tight">SilentPayroll</h1>
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 space-y-4">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Stealth address batch payroll for DAOs. Pay employees privately while maintaining treasury accountability.
          </p>
        </div>
