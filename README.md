<div align="center">
  <img src="docs/assets/readme-hero.png" alt="Shawage Hero" width="100%">
  
  <p><em>Compliance-First Private Payroll</em></p>
  
  [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen.svg)](https://umbra.vercel.app)
  [![Pitch Video](https://img.shields.io/badge/Pitch-Video-red.svg)](https://youtube.com/your-video)
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-umbra)
</div>
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-umbra.git
   cd frontier-umbra
   ```
